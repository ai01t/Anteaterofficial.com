...
<div suppressHydrationWarning className="bg-white/5 backdrop-blur-md rounded-lg p-6 text-base text-black text-center md:text-left">
  <p className="mb-3">Est. 2018, Prague</p>
                    ...
                    <p className="mb-3" suppressHydrationWarning>
                      <strong suppressHydrationWarning>2026</strong>{" The band is building"} its own unique studio—a creative hub where new material is currently in the works. Housed in a historic property dating back to the 17th century, the main studio space inside the old water mill will also be open to the public. For more information, visit{" "}
