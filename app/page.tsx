              ...
              <div className="relative">
                <div className="md:pr-8 pb-8">
                  ...
                  <div className="bg-white/5 backdrop-blur-md rounded-lg p-6 text-base text-black text-center md:text-left">
                    ...
                    <p>
                      <strong className="font-bold">2026</strong> The band is building its own unique studio—a creative
                      hub where new material is currently in the works. Housed in a historic property dating back to the
                      17th century, the main studio space inside the old water mill will also be open to the public. For
                      more information, visit{" "}
                      <a
                        href="https://mlynnapile.cz"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="font-bold hover:opacity-60 transition no-underline"
                      >
