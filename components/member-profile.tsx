...
const profiles: Profile[] = [
  ...
  },
  {
    ...
    bio: {
      ...
      cz: "Jindřich Traxmandl hraje na kytaru, ale pro Anteater nahrával i basu a trochu hraje na bicí. Jindra má rád moderní technologie, ale v hudbě preferuje staré aparáty a vintage nástroje. V roce 2026 buduje vlastní kreativní studio, kde vzniká nový materiál.",
    },
    ...
    <main className="profile-page" style={{ "--profile-image": `url(${profile.image})` } as React.CSSProperties}>
      ...
      <section className="profile-content" aria-label={`${profile.name} profile details`}>
        ...
        <Disclosure label={locale === "de" ? "GEAR / INSTRUMENTE" : locale === "cz" ? "GEAR / NA CO HRAJE" : "GEAR / WHAT THEY PLAY"} open={gearOpen} onClick={() => setGearOpen(!gearOpen)}>
          ...
          {locale === "cz" && <p className="gear-heading song-heading">Studio / Live Signal Chain</p>}
