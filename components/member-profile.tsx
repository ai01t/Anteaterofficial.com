...
function renderInstrument(instrument: string) {
  const displayInstrument = instrument
    .replace(/Fender ’64 Custom Deluxe Reverb, 20W hand-wired \+ D&M Drive distortion\) Usually combined with Fender Custom Shop – Jeff Beck or Fender Custom Shop LTD ’67 HSS Strat AB HR \(\+ D&M Drive distortion\)/, "Fender ’64 Custom Deluxe Reverb, 20W hand-wired combo with Jensen C12K. V kombinaci s Fender Custom Shop – Jeff Beck nebo Fender Custom Shop LTD ’67 HSS Strat AB HR")
  .replace("Fender ’64 Custom Deluxe Reverb, 20W hand-wired combo s Jensenem C12K.", "Fender ’64 Custom Deluxe Reverb, 20W hand-wired combo with Jensen C12K. V kombinaci s Fender Custom Shop – Jeff Beck nebo Fender Custom Shop LTD ’67 HSS Strat AB HR")
