...
const profiles: Profile[] = [
  ...
  },
  {
    ...
    bio: {
      ...
      cz: "Jindra hraje na kytaru, ale pro Anteater nahrával i basu a rád si zahraje i na bicí... Jindra má rád moderní technologie, ale v hudbě preferuje staré aparáty a vintage naástroje.\n\nV roce 2026 buduje vlastní kreativní studio, kde vzniká nový materiál.",
    },
    ...
    <main className="profile-page" style={{ "--profile-image": `url(${profile.image})` } as React.CSSProperties}>
      ...
      <section className="profile-content" aria-label={`${profile.name} profile details`}>
        ...
        <Disclosure label={locale === "de" ? "GEAR / INSTRUMENTE" : locale === "cz" ? "GEAR / NA CO HRAJE" : "GEAR / WHAT THEY PLAY"} open={gearOpen} onClick={() => setGearOpen(!gearOpen)}>
          ...
          {locale === "cz" && profile.slug !== "andy" && profile.slug !== "hanzi" && <p className="gear-heading song-heading">Studio / Live Signal Chain</p>}
...
function renderInstrument(instrument: string) {
  const displayInstrument = instrument
    .replace(/Fender ’64 Custom Deluxe Reverb, 20W hand-wired \+ D&M Drive distortion\) Usually combined with Fender Custom Shop – Jeff Beck or Fender Custom Shop LTD ’67 HSS Strat AB HR \(\+ D&M Drive distortion\)/, "Fender ’64 Custom Deluxe Reverb, 20W hand-wired combo (+ D&M Drive distortion) usually combined with Fender Custom Shop – Jeff Beck or Fender and Custom Shop LTD ’67 HSS Strat AB HR")
    .replace("Fender ’64 Custom Deluxe Reverb, 20W hand-wired combo s Jensenem C12K.", "Fender ’64 Custom Deluxe Reverb, 20W hand-wired combo (+ D&M Drive distortion) usually combined with Fender Custom Shop – Jeff Beck or Fender and Custom Shop LTD ’67 HSS Strat AB HR")
